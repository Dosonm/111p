...
{
    public class SplashShaderInspector_SPFXKMINIV01 : ShaderGUI
    {
        ...
        void DrawTitle()
        {
            ...
            Texture2D titleImage1 = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/CriticalVFX/StylizedProjectileFXKit_Vol1/Editor/Image/01.png");
            Texture2D titleImage2 = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/CriticalVFX/StylizedProjectileFXKit_Vol1/Editor/Image/02.png");

            DrawImage(rect, titleImage1, targetHeight, ImageAlignment.Left);
            DrawImage(rect, titleImage2, targetHeight, ImageAlignment.Right);
        }
        ...
        void DrawImage(Rect rect, Texture2D image, float targetHeight, ImageAlignment alignment)
        {
            if (image != null)
            {
